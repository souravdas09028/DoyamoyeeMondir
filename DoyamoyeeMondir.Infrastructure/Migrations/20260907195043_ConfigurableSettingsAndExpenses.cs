...
{
    /// <inheritdoc />
    public partial class ConfigurableSettingsAndExpenses : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_MembershipType_Amount", "[Amount] >= 0");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TempleServices", x => x.Id);
                    table.CheckConstraint("CK_TempleService_Allocation", "[Amount] >= 0 AND [TempleShare] >= 0 AND [PriestShare] >= 0 AND [StaffShare] >= 0 AND [Amount] = [TempleShare] + [PriestShare] + [StaffShare]");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Expenses_SubmissionKey",
                table: "Expenses",
